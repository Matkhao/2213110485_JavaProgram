...
public class EmployeeInfo {
	...
	public static void main(String[] args) throws IOException {
		...
		if(choice.equals("insert")) {
			...
			System.out.print("\nEnter department: ");
			department = console.next(); // <------ รับข้อมูลแผนกจากผู้ใช้
			file.setDept(department); // <----- send department to setDept() Method ส่งแผนกผู้ใช้ให้กับเมทอด setDept()
			file.read(); // <----- call read() method from SaveandOpen Class เรียกใช้เมทอด Read ใน SaveandOpen Class
		}
